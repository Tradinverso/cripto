...
<html lang="es">
  <head>
    ...
    <style>
      ...
      main { width: min(420px, calc(100% - 48px)); padding: 34px; border: 1px solid #e1e5eb; border-radius: 16px; background: white; text-align: center; box-shadow: 0 24px 70px rgba(20, 34, 57, .12); }
