  ...
  return (
    <main className="contract-page">
      ...
      <article className="contract-sheet">
        ...
        <section><h2>Datos para el pago</h2><dl className="crypto-details"><dt>Moneda</dt><dd>{student.currency}</dd><dt>{student.currency === "EUR" ? "Método" : "Red"}</dt><dd>{student.network || "____________________________"}</dd><dt>{student.currency === "EUR" ? "Destino" : "Wallet"}</dt><dd>{student.currency === "EUR" ? (student.network === "SeQura" ? "Gestión mediante SeQura" : privateConfig.provider.phone) : student.wallet || "____________________________"}</dd></dl></section>
