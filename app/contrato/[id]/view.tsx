  ...
  return (
    <main className="contract-page">
      ...
      <article className="contract-sheet">
        ...
        <section><h2>Qué incluye Tradinverso</h2><p>La formación está dividida en tres pilares: Trading, Psicotrading y Optimización Financiera.</p><p>Desde el primer pago, el alumno tendrá acceso al Pilar Trading, al software TRADINVERSO, a la comunidad, a los directos, a las operativas, al canal de seguimiento, a una evaluación inicial y a una sesión inicial de onboarding. Los demás pilares formativos se abrirán progresivamente con cada pago.</p></section>

        <section><h2>Cómo se abre el acceso</h2><table><thead><tr><th>Momento</th><th>Formación</th><th>Acceso y servicios</th></tr></thead><tbody><tr><td>Después del pago 1</td><td>Pilar Trading</td><td>Software TRADINVERSO, comunidad, directos, operativas, canal de seguimiento, evaluación inicial y una sesión de onboarding</td></tr><tr><td>Después del pago 2</td><td>Se añade Psicotrading</td><td>Continúan la comunidad, los directos, las operativas y el canal de seguimiento</td></tr><tr><td>Después del pago 3</td><td>Se añade Optimización Financiera</td><td>Acceso completo a todo el programa confirmado</td></tr>{student.plan === 4 && <tr><td>Después del pago 4</td><td>Los tres pilares permanecen disponibles</td><td>Se mantiene el acceso completo a todo el programa</td></tr>}</tbody></table></section>
